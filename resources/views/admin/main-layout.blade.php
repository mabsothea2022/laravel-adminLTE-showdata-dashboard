...
<head>
    ...
    <link href="{{ asset('asset/admin_assets/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet"
        type="text/css">
    <link
    ...
    <link href="{{ asset('asset/admin_assets/css/sb-admin-2.min.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('asset/admin_assets/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('asset/admin_assets/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('asset/admin_assets/js/demo/chart-pie-demo.js') }}"></script>
</body>
